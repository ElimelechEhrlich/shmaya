...
const CustomerList: React.FC = () => {
    ...
    || (client.businessDetails?.businessID || '').includes(filters.search || '');        const matchesType = filters.businessType === '' || client.businessDetails?.businessType === filters.businessType;
