    ...
    return (
        <div className="p-6 max-w-7xl mx-auto" dir="rtl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white p-6 rounded-2xl border border-slate-200 border-t-4 border-blue-500 shadow-sm">
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 border-t-4 border-amber-500 shadow-sm">
                    <span className="text-2xl">⏳</span>
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 border-t-4 border-emerald-500 shadow-sm">
                    <span className="text-2xl">✅</span>
